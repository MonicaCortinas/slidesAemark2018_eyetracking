...
- **Atención** es tanto un **requisito** para la respuesta como un antecedente importante de la UX global.
...
- La **presentación de información en esta área** es crítica para el éxito (Flavián et al 2002).

- Esta es el área que se **observa durante más tiempo** (Cortinas et al 2019).
]
